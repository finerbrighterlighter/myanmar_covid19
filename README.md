...
![](/case/20-04-2020_total_cases.svg)

<img src="/case/20-04-2020_total_dist.svg" alt=" " width="500"/>

## New Cases by day

![](/case/20-04-2020_new_cases.svg)

## New Cases growth compared with high mortality countries
### United States, Italy, Spain, France, United Kingdom

![](/compared/20-04-2020_comparison.svg)

## Infection Spread Trend

![](/spread/20-04-2020_spread.svg)
...
![](/age/20-04-2020_age.svg)

## Confirmed Patients' Status

![](/status/20-04-2020_status.svg)
...
![](/timelines/20-04-2020_time_for_action.svg)

## Current Timeline 
**TIMELINES ARE LIKELY TO BE DEPRECATED IN FURTURE DAYS SINCE MOHS DECIDED TO BEING OPEN IS HARMFUL**
![](/timelines/20-04-2020_timeline.svg)

## Underlying conditions of the expired patients

<img src="/underlying/20-04-2020_underlying.svg" alt=" " width="650"/>

## Mortality Rate

![](/mortality/20-04-2020_exp.svg)
...
![](/qua_ppl/21-04-2020_qua_ppl_cen.svg)

| per region | distribution across country |
|-|-|
|![](/qua_ppl/21-04-2020_qua_ppl_reg.svg)|![](/qua_ppl/21-04-2020_qua_ppl_dis.svg)|
|![](/qua_cen/21-04-2020_qua_cen_reg.svg)|![](/qua_cen/21-04-2020_qua_cen_dis.svg)|
|![](/pui/21-04-2020_pui_reg.svg)|![](/pui/21-04-2020_pui_dis.svg)|
...
Natural log makes it better in terms of visualization and long term comparison, make the data look more linear. That is why I will be plotting both real and natural log line graphs.<br>
 ...
 |-|-|
  |![](/plots_after_revision/20-04-2020_real.svg)|![](/plots_after_revision/20-04-2020_log.svg)|
